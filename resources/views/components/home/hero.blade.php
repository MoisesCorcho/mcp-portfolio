      ...
      <div class="w-full lg:w-5/12 px-4">
        <div class="hero-content">
          ...
          <p class="text-base mb-8 max-w-[520px] dark:text-slate-200">
            Soy un desarrollador web enfocado en backend con 4 años de experiencia con experticia en PHP, Laravel y bases de datos, especializado en resolver problemas lógicamente y colaborar eficazmente en entornos desafiantes.
            {{-- <a
              class="text-primary font-bold no-underline hover:underline underline-offset-2 decoration-2 decoration-primary"
              href="" target="_blank">Gitbub</a>. <br>
          </p> --}}
