...
>
  <div class="relative mb-12">
    ...
    <div
      ...
      <span class="text-sm text-blue-500 font-semibold block mb-2">
        {{ implode(", ", $categories) }}
      </span>
      <h3 class="font-bold text-lg text-slate-300 dark:text-gray-300 mb-4">
        {{ $title }}
      </h3>
      <x-button-link :href="$github" variant="outline-primary" class="text-white">Ver Detalles</x-button-link>
    </div>
  </div>
</div>
